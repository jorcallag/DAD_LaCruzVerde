...
public class planta {
	...
	public planta(int id_planta, String nombre_planta, float temp_amb_planta, float humed_tierra_planta) {
		super();
	...
	public String toString() {
		return "planta [id_planta=" + id_planta + ", nombre_planta=" + nombre_planta + ", temp_amb_planta="
				+ temp_amb_planta + ", humed_tierra_planta=" + humed_tierra_planta + "]";
	}
